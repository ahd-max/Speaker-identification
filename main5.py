# -*- coding: utf-8 -*-
"""
Created on Sat Nov 19 21:59:23 2022
...
if __name__ == '__main__':
    import load5
    from dp_refined5 import Network

    train_samples, train_labels = load5._train_samples, load5._train_labels
    test_samples, test_labels = load5._test_samples, load5._test_labels
    ...
    image_size = load5.image_size
    image_size1= load5.image_size1
    num_labels = load5.num_labels
    num_channels = load5.num_channels
    ...
    net = Network(
        train_batch_size=64, test_batch_size=120, pooling_scale=2,
        dropout_rate=0.9,
        base_learning_rate=0.00005, decay_rate=0.45)
    net.define_inputs(
        train_samples_shape=(64, image_size, image_size1, num_channels),
