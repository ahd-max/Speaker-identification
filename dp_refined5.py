# -*- coding: utf-8 -*-
"""
Created on Sat Nov 19 20:41:52 2022
...
class Network():
    ...
    def add_conv(self, *, patch_size, in_depth, out_depth, activation='relu', pooling=False, name):
        ...
        with tf.name_scope(name):
            weights = tf.Variable(
                tf.random.truncated_normal([patch_size, patch_size, in_depth, out_depth], stddev=0.1), name=name + '_weights')
    ...
    def visualize_filter_map(self, tensor, *, how_many, display_size, name):
        ...
        # print(filter_map.get_shape())
        filter_map = tf.reshape(filter_map, (how_many, display_size*2, display_size*2, 1))
        # print(how_many)
