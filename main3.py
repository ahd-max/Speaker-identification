...
if __name__ == '__main__':
    import load3
    from dp_refined3 import Network

    train_samples, train_labels = load3._train_samples, load3._train_labels
    test_samples, test_labels = load3._test_samples, load3._test_labels
    ...
    image_size = load3.image_size
    image_size1= load3.image_size1
    num_labels = load3.num_labels
    num_channels = load3.num_channels
