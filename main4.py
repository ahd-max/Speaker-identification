# -*- coding: utf-8 -*-
"""
Created on Sat Nov 19 20:42:07 2022

@author: Hangdong AN
"""
if __name__ == '__main__':
    import load4
    from dp_refined4 import Network

    train_samples, train_labels = load4._train_samples, load4._train_labels
    test_samples, test_labels = load4._test_samples, load4._test_labels
    ...
    image_size = load4.image_size
    image_size1= load4.image_size1
    num_labels = load4.num_labels
    num_channels = load4.num_channels
    ...
    net = Network(
        ...
        dropout_rate=0.9,
        base_learning_rate=0.00005, decay_rate=0.99)
    net.define_inputs(
